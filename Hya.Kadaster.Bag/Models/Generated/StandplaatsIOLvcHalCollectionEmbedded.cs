...
/// </summary>
[DataContract]
public class StandplaatsIOLvcHalCollectionEmbedded
{
    /// <summary>
    ...
    public List<StandplaatsIOHal> Voorkomens { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class StandplaatsIOLvcHalCollectionEmbedded {\n");
