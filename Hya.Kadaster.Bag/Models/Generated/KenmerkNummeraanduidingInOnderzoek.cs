...
/// </summary>
[DataContract]
public class KenmerkNummeraanduidingInOnderzoek
{
    /// <summary>
    ...
    public InOnderzoekNummeraanduiding Kenmerk { get; set; }

    /// <summary>
    ///     Gets or Sets IdentificatieVanNummeraanduiding
    /// </summary>
    [DataMember(Name = "identificatieVanNummeraanduiding", EmitDefaultValue = false)]
    [JsonPropertyName("identificatieVanNummeraanduiding")]
    public string IdentificatieVanNummeraanduiding { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class KenmerkNummeraanduidingInOnderzoek {\n");
        sb.Append("  Kenmerk: ").Append(Kenmerk).Append("\n");
        sb.Append("  IdentificatieVanNummeraanduiding: ").Append(IdentificatieVanNummeraanduiding).Append("\n");
