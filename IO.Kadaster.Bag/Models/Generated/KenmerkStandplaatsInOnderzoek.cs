...
/// </summary>
[DataContract]
public class KenmerkStandplaatsInOnderzoek
{
    /// <summary>
    ...
    public InOnderzoekStandplaats Kenmerk { get; set; }

    /// <summary>
    ///     Gets or Sets IdentificatieVanStandplaats
    /// </summary>
    [DataMember(Name = "identificatieVanStandplaats", EmitDefaultValue = false)]
    [JsonPropertyName("identificatieVanStandplaats")]
    public string IdentificatieVanStandplaats { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class KenmerkStandplaatsInOnderzoek {\n");
        sb.Append("  Kenmerk: ").Append(Kenmerk).Append("\n");
        sb.Append("  IdentificatieVanStandplaats: ").Append(IdentificatieVanStandplaats).Append("\n");
