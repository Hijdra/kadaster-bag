...
/// </summary>
[DataContract]
public class NummeraanduidingIOLvcHalCollectionEmbedded
{
    /// <summary>
    ...
    public List<NummeraanduidingIOHal> Voorkomens { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class NummeraanduidingIOLvcHalCollectionEmbedded {\n");
