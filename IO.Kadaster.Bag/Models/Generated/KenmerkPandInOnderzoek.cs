...
/// </summary>
[DataContract]
public class KenmerkPandInOnderzoek
{
    /// <summary>
    ...
    public InOnderzoekPand Kenmerk { get; set; }

    /// <summary>
    ///     Gets or Sets IdentificatieVanPand
    /// </summary>
    [DataMember(Name = "identificatieVanPand", EmitDefaultValue = false)]
    [JsonPropertyName("identificatieVanPand")]
    public string IdentificatieVanPand { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class KenmerkPandInOnderzoek {\n");
        sb.Append("  Kenmerk: ").Append(Kenmerk).Append("\n");
        sb.Append("  IdentificatieVanPand: ").Append(IdentificatieVanPand).Append("\n");
