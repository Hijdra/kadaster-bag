...
/// </summary>
[DataContract]
public class KenmerkOpenbareRuimteInOnderzoek
{
    /// <summary>
    ...
    public InOnderzoekOpenbareRuimte Kenmerk { get; set; }

    /// <summary>
    ///     Gets or Sets IdentificatieVanOpenbareRuimte
    /// </summary>
    [DataMember(Name = "identificatieVanOpenbareRuimte", EmitDefaultValue = false)]
    [JsonPropertyName("identificatieVanOpenbareRuimte")]
    public string IdentificatieVanOpenbareRuimte { get; set; }
    ...
    /// </summary>
    /// <value>
    ///     Het nummer van het document waarin de grondslag van het onderzoek wordt  vastgelegd.  Dit wordt vastgelegd in
    ///     het attribuut documentnummer.
    /// </value>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class KenmerkOpenbareRuimteInOnderzoek {\n");
        sb.Append("  Kenmerk: ").Append(Kenmerk).Append("\n");
        sb.Append("  IdentificatieVanOpenbareRuimte: ").Append(IdentificatieVanOpenbareRuimte).Append("\n");
