...
/// </summary>
[DataContract]
public class KenmerkLigplaatsInOnderzoek
{
    /// <summary>
    ...
    public InOnderzoekLigplaats Kenmerk { get; set; }

    /// <summary>
    ///     Gets or Sets IdentificatieVanLigplaats
    /// </summary>
    [DataMember(Name = "identificatieVanLigplaats", EmitDefaultValue = false)]
    [JsonPropertyName("identificatieVanLigplaats")]
    public string IdentificatieVanLigplaats { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class KenmerkLigplaatsInOnderzoek {\n");
        sb.Append("  Kenmerk: ").Append(Kenmerk).Append("\n");
        sb.Append("  IdentificatieVanLigplaats: ").Append(IdentificatieVanLigplaats).Append("\n");
